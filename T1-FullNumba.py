...
@njit #--Numba Ver--#
def create_grid(N, width, grid_index, grid):
    for particle in range(N):
        # Particle's index
...
for i in range(int(end_time / dt)):
    ...
    x, v = simulation_step(N, dt, radius, spring, gravity, box_length, length, width, x, v, box) # Change inputs later to match SimulationStep in instructions - convinient now
